    ...
    <div className="App">
      <div>
        <img
          ...
          width="80"
          height="80"
          onClick={(event) => window.open("https://fcefyn.unc.edu.ar/facultad/secretarias/academica/escuelas/ingenieria-computacion/ingenieria-en-computacion/", '_blank', 'noopener,noreferrer')} />
      </div>
      <div style={{
        position: 'absolute',
        top: '60px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a style={{
            ...
            display: 'flex',
            textDecoration: 'none !important',
          }} href='https://github.com/sofiavalos/ICOMP05/'>
